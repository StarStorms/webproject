...
<form action="index.php?page=inscription" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <input type="email" id="email" name="email" placeholder="Votre e-mail" class="form-control"required <?php if(isset($_POST['email']))echo'value="'.$_POST['email'].'"';?>>
    </div>
    <div class="form-group">
        <label for="emailConfirm">E-mail de confirmation: </label>
        <input type="email" id="emailConfirm" name="emailConfirm" placeholder="Réencodez votre e-mail" class="form-control" required <?php if(isset($_POST['emailConfirm']))echo'value="'.$_POST['emailConfirm'].'"';?>>
    </div>
    <div class="form-group">
